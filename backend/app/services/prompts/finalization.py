...
FINALIZATION_PROMPT = (
    ...
    "{pending_block}"
    "If any open threads above were directed at you, briefly acknowledge "
    "and answer them at the start of your response (one or two sentences). "
    "Then, considering everything that has been said, state your post-"
    ...
    "After any pending-thread acknowledgement, begin the opinion portion "
    "with one of:\n"
    "  - \"My revised opinion:\" (if Option A)\n"
    "  - \"I agree with <participant name>:\" (if Option B)\n\n"
    "Keep the whole response under 12 sentences."
)
